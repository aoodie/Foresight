...
export async function POST(request: Request) {
  ...
  if (body?.confirm !== true) return NextResponse.json({ error: "Flattening is locked. Confirm the close action explicitly." }, { status: 409 });
